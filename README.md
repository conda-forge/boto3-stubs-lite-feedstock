...
Summary: Type annotations for boto3 1.43.103, generated with mypy-boto3-builder
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/boto3-stubs-lite-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/boto3-stubs-lite-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add boto3-stubs-lite boto3-stubs-lite-essential
# for installing globally
pixi global install boto3-stubs-lite boto3-stubs-lite-essential
```
...
It is possible to list all of the versions of `boto3-stubs-lite` available on your platform:
...
```
pixi search boto3-stubs-lite --channel conda-forge
```
